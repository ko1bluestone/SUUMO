...
# サービスアカウントの JSON キーファイルへのパス
json_keyfile_path = "tech0-step3-trial-f1dd32975f8b.json"
# jsonファイルを使って認証情報を取得
SCOPES = ["https://www.googleapis.com/auth/spreadsheets"]
# スコープを指定してサービスアカウントの認証
credentials = ServiceAccountCredentials.from_json_keyfile_name(json_keyfile_path, SCOPES)
gs = gspread.authorize(credentials)

# スプレッドシートの作成
# wb = gc.create("test02_1")

#共有したスプレッドシートのキーを使ってシートの情報を取得
SPREADSHEET_KEY = "1xe2dSVNDlYCTwhsyR-IEkbPkosiRvNAdYlXLQtt9naQ"
